...
<!--[if (gte IE 9)|(gt IEMobile 7)|!(IEMobile)|!(IE)]><!--><html <?php language_attributes(); ?> class="no-js"><!--<![endif]-->
	...
	<head>
		...
		<script type="text/javascript"> 
			...
			var _gaq = _gaq || [];
			_gaq.push(['_setAccount', 'UA-36023075-1']);
		...
		<link rel="stylesheet" href="http://satellitecap.com/js/envision.min.css" type="text/css"/>
		<link type="text/css" rel="stylesheet" href="http://satellitecap.com/js/jquery.qtip.min.css" />
		
		
		<script type="text/javascript" src="http://use.typekit.com/biz0tzu.js"></script>
					...
					<div class="navbar-inner">
						<div class="container-fluid nav-container">
							...
							<div id="client-login" class="clearfix">
								<a href="#" id="login_button" class="show_hide button">Client Login</a>
								
								<div id="flash" class="popup">
									<a href="#" class="show_hide closebutton">Close</a>	
									<?php login_with_ajax() ?>
									<?php if (is_user_logged_in() ) { 
										}else{ 
											echo " <p>Need an account? <a href='mailto:info@satellitecap.com'>Contact Us</a> to get started.</p>";
											} ?>
								</div>
							</div>
