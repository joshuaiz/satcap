...
jQuery(document).ready(function(){
  ...
  jQuery(".show_hide").click(function(){
    jQuery(this).next(".popup").slideToggle("slow");
  });

  jQuery(".show_hide a").toggle(function(){
    jQuery(".popup").slideDown(); 
    jQuery(this).text('Close');
    }, function () {
    jQuery(".popup").slideUp();
    jQuery(this).text('Client Login');
  });
 
  jQuery(".closebutton a").click(function(){
    jQuery(".popup").slideUp();
    return false;
  });
