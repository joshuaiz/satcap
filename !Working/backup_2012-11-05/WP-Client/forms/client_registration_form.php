...
if ( isset( $btnAdd ) ) {
	...
	if ( empty( $error ) ) {
        ...
        $wpc_client_page = get_pages( $page_args );
        if ( isset( $wpc_client_page[0] ) && 0 < $wpc_client_page[0]->ID ) {
            do_action('wp_client_redirect', get_permalink( $wpc_client_page[0]->ID ) );
        } else {
         ...
         <table class="form-table">
            ...
            <tr>
                <td scope="row">
                    ...
                    <br />
                    <label for="send_password"><input type="checkbox" name="user_data[send_password]" id="send_password" /><?php _e( 'Send this password to email.', WPC_CLIENT_TEXT_DOMAIN ) ?></label>
                </td>
            </tr>
            <tr>
                <td>
